...
* @ignore
*/
namespace kyah\mushraider_bridge\acp;
...
class main_module {
   ...
   var $new_config = array();
                ...
                $display_vars = array(
                    ...
                    'vars'    => array(
                        ...
                        'mrb_hashkey' => array(
                            ...
                            'type'      => 'text:16:45',
                            'explain'   => true),
                        'mrb_third_party' => array(
                            'lang'      => 'MUSHRAIDER_THIRD_PARTY_URL',
                            'validate'  => 'string',
                            'type'      => 'custom',
                            'method'    => 'get_mush_third_party',
                            'submit'    => 'set_mush_third_party',
                            'explain'   => true),
                    ),
                );
    ...
    public function get_mush_third_party()
    {
        global $config;
        $result = generate_board_url().'/app.php/mushraider_bridge';
        return $result;
    }
    
    public function set_mush_third_party()
    {
        return True;
    }
